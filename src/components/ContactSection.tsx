export default function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-gray-100 py-20 dark:bg-gray-850">
        ...
        <div className="flex justify-center gap-8">
          {contactOptions.map((contact, index) => (
            <a
              ...
              className="animate-fade-in-up flex flex-col items-center gap-3 rounded-xl bg-white p-6 transition-all duration-300 hover:scale-110 hover:bg-gray-50 hover:shadow-lg dark:bg-gray-700 dark:hover:bg-gray-600"
